       ...
       WORKING-STORAGE SECTION.
           01  MYSTERY-NUMBER     PIC 9(3) VALUE 42.
       ...
       PROCEDURE DIVISION.
           ...
           PERFORM UNTIL GAME-OVER = "Y"
               ...
               IF USER-GUESS LESS THAN MYSTERY-NUMBER THEN
                   DISPLAY "Trop petit !"
               ELSE
                   IF USER-GUESS GREATER THAN MYSTERY-NUMBER THEN
                       DISPLAY "Trop grand !"
                   ELSE
                       DISPLAY "Bravo ! Tu as trouvé en ".
                       DISPLAY ATTEMPTS.
                       DISPLAY " essais !"
                       MOVE "Y" TO GAME-OVER
                   END-IF
